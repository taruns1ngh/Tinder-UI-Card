      ...
      if (i < this.state.currentIndex) {
        ...
        return (
          <Animated.View
            ...
            <Animated.View style={{ opacity: this.likeOpacity, transform: [{ rotate: '0deg' }], position: 'absolute', top: 50, left: 40, zIndex: 1000 }}>
              <Text style={{ borderWidth: 1, borderColor: 'green', color: 'green', fontSize: 32, fontWeight: '800', padding: 10 }}>✅</Text>
               
            </Animated.View>

            <Animated.View style={{ opacity: this.dislikeOpacity, transform: [{ rotate: '0deg' }], position: 'absolute', top: 50, right: 40, zIndex: 1000 }}>
